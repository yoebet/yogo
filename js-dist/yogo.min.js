function Board(a,c,b){this.boardContainer=a;"string"===typeof a&&(this.boardContainer=document.getElementById(a));b?(b.clear(),this.paper=b):this.paper=Raphael(a);"number"===typeof c?(this.boardSize=c,this.boardSetting=Board.getDefaultBoardSetting(this.boardSize)):"object"===typeof c&&(this.boardSetting=c,this.boardSize=this.boardSetting.boardSize);this.pointStatusMap={};this.zoomMode=null;a=function(a,c){for(var b=0;b<c.length;b++){var g=c[b],k=a[g];"function"!==typeof k?yogo.logWarn(g+" is not a function",
"board init"):this[g]=k.bind(a)}};this.coordinateManager=new Board.Coordinate(this);a.call(this,this.coordinateManager,["drawCoordinate","hideCoordinate","showCoordinate","boardCoorToViewBoxCoor"]);this.stoneManager=new Board.Stone(this);a.call(this,this.stoneManager,"placeStone removeStone addStones removeStones showMoveNumber showMoveNumbers hideMoveNumbers unmarkCurrentMoveNumber".split(" "));this.markerManager=new Board.Marker(this);a.call(this,this.markerManager,["setMarker","setMarkers","removeMarker",
"removeAllMarkers","markCurrentMove"]);this.labelManager=new Board.Label(this);a.call(this,this.labelManager,["setLabel","setLabels","removeLabel","removeAllLabels","removeBranchPointLabels"])}
...
d||d.status.capture||d.status.setup)b.previousNode!=d||b.status.capture||b.status.setup?(d=this.diffPosition(b.position,d.position),c.removeStones(d.stonesToRemove),c.addStones(d.stonesToAddB,"B"),c.addStones(d.stonesToAddW,"W")):(e=b.move.point)&&c.removeStone(e);else{var e=d.move.point;e&&c.placeStone(e,d.move.color)}}else a=(new PositionBuilder(this,d)).buildPosition();this.setCurrentNodeMarkers();this.handleMoveNumbers(b);"function"===typeof this.onPlayNode&&this.onPlayNode.call(this);return a},
gotoNextX:function(a){for(var c=this.curNode;;){if(c.nextNode)c=c.nextNode;else if(c.variations)c=c.variations[0].nodes[0];else return!1;if(!c)return!1;if(a.call(c,c))return this.playNode(c)}},gotoLastX:function(a){for(var c=this.curNode;;){c=c.previousNode;if(!c)return!1;if(a.call(c,c))return this.playNode(c)}},gotoNode:function(a){var c;"string"===typeof a?c=this.nodeMap[a]:"number"===typeof a?c=this.nodesByMoveNumber[a]:a instanceof Node&&(c=a);return c?this.playNode(c):!1},gotoBeginning:function(){return this.playNode(this.gameModel.nodes[0])},
gotoGameEnd:function(){return this.playNode(this.gameEndingNode)},fastFoward:function(a){a=a||10;for(var c=this.curNode;0<a;a--)if(c.nextNode)c=c.nextNode;else if(c.variations)c=c.variations[0].nodes[0];else break;return this.playNode(c)},fastBackward:function(a){a=a||10;for(var c=this.curNode;0<a;a--)if(c.previousNode)c=c.previousNode;else break;return this.playNode(c)},goinBranch:function(a){var c=this.curNode.variations;if(c){var b;"number"===typeof a?b=c[a]:"string"===typeof a&&1==a.length&&(a=
a.charCodeAt(0)-65,b=c[a]);if(b)return this.playNode(b.nodes[0])}return!1},gotoVariationBegin:function(){return this.inRealGame()||this.curNode.status.variationFirstNode?!1:this.gotoLastX(function(a){return a.status.variationFirstNode})},gotoVariationEnd:function(){return this.inRealGame()||this.curNode.status.variationLastNode?!1:this.gotoNextX(function(a){return a.status.variationLastNode})},backFromVariation:function(){return this.inRealGame()?!1:this.playNode(this.curNode.belongingVariation.baseNode)},
inRealGame:function(){return this.curNode.belongingVariation.realGame}};function GameModel(){this.realGame=!0;this.nodes=[]}GameModel.prototype={traverseNodes:function(a,c,b){for(var d=this.nodes,e=0;e<d.length;e++){var f=d[e];if(c&&!1===c.call(f,f,b))break;if(f=f.variations)for(var g=0;g<f.length;g++){var k=f[g];if(a&&!1===a.call(k,k,b))return b;k.traverseNodes(a,c,b)}}return b},selectNodes:function(a){return traverseNodes(null,function(c,b){a.call(c,c)&&b.push(c)},[])}};
function Variation(a,c){this.baseNode=a;this.parentVariation=c;this.realGame=!1;this.nodes=[]}Variation.prototype=GameModel.prototype;function Node(a,c){this.previousNode=a;this.belongingVariation=c;this.props={};this.status={}}Node.prototype={};String.prototype.trim||(String.prototype.trim=function(){rtrim=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;return this.replace(rtrim,"")});
...
a instanceof Array||(a=[a]):a instanceof Array&&(a=a[0]||""),"point"==c)a=""==a?null:this.parseCoordinate(a,b);else if("lableList"==c){c=[];for(d=0;d<a.length;d++){var e=a[d].split(":"),f=e[0];if(e=e[1])f=this.parseCoordinate(f,b),null!=f&&(f.label=e,c.push(f))}a=0<c.length?c:null}else if("pointList"==c){c=[];for(d=0;d<a.length;d++)f=a[d],0<f.indexOf(":")?(e=f.split(":"),f=this.parseCoordinate(e[0],b),e=this.parseCoordinate(e[1],b),f&&e&&c.push({coorFrom:f,coorTo:e})):(f=this.parseCoordinate(f,b),
null!=f&&c.push(f));a=0<c.length?c:null}else"triple"==c?a="2"==a?2:1:"bool"==c?a=!0:"integer"==c?(a=parseInt(a),isNaN(a)&&yogo.logWarn("can't parse to Integer: "+name+","+d,"node")):"float"==c?(a=parseFloat(a),isNaN(a)&&yogo.logWarn("can't parse to Float: "+name+","+d,"node")):yogo.logWarn("to do: "+name,"node");return a}};SgfParser.parse=function(a){var c=new SgfParser;a=c.parseSgf(a);c.buildGoGameModel(a);return a};
