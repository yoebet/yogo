function Board(a,c){this.boardContainer=a;"string"===typeof a&&(this.boardContainer=document.getElementById(a));this.paper=Raphael(a);"number"===typeof c?(this.boardSize=c,this.boardSetting=Board.getDefaultBoardSetting(this.boardSize)):"object"===typeof c&&(this.boardSetting=c,this.boardSize=this.boardSetting.boardSize);this.pointStatusMap={};this.zoomMode=null;var b=function(a,c){for(var b=0;b<c.length;b++){var g=c[b],k=a[g];"function"!==typeof k?yogo.logWarn(g+" is not a function","board init"):
this[g]=k.bind(a)}};this.coordinateManager=new Board.Coordinate(this);b.call(this,this.coordinateManager,["drawCoordinate","hideCoordinate","showCoordinate","boardCoorToViewBoxCoor"]);this.stoneManager=new Board.Stone(this);b.call(this,this.stoneManager,"placeStone removeStone addStones removeStones showMoveNumber showMoveNumbers hideMoveNumbers unmarkCurrentMoveNumber".split(" "));this.markerManager=new Board.Marker(this);b.call(this,this.markerManager,["setMarker","setMarkers","removeMarker","removeAllMarkers",
"markCurrentMove"]);this.labelManager=new Board.Label(this);b.call(this,this.labelManager,["setLabel","setLabels","removeLabel","removeAllLabels","removeBranchPointLabels"])}
...
function Game(a,c){this.board=a;this.gameModel=c;this.boardSize=c.boardSize;this.curNode=c.nodes[0];this.markBranchPoints=this.markCurrentMove=!0;this.showMoveNumber=!1;this.showMoveNumberCount=10;this.hideMoveNumberTemporarily=!1;this.gameEndingNode=null;var b=this.variationMap={},d=this.nodeMap={},e=this.nodesByMoveNumber=[],f=this;this.gameModel.traverseNodes(function(a,c){a.id="v"+c.seq++;b[a.id]=a},function(a,c){a.id="n"+c.seq++;d[a.id]=a;if(a.belongingVariation.realGame){var b=a.numbers.globalMoveNumber;
b&&!e[b]&&(e[b]=a);a.nextNode||a.variations||(f.gameEndingNode=a)}},{seq:1E3});for(var g=[{name:"Node",predicate:function(){return!0}},{name:"Branch",predicate:function(a){return!!a.variations}},{name:"Remark",predicate:function(a){return a.status.remark}},{name:"Comment",predicate:function(a){return a.status.comment}},{name:"Marks",predicate:function(a){return a.status.mark}},{name:"Ko",predicate:function(a){a=a.status;return a.positionBuilt&&(a.startKo||a.ko)}},{name:"Capture",predicate:function(a){return a.status.positionBuilt&&
a.status.capture}},{name:"NotEvaluated",predicate:function(a){return!a.status.positionBuilt}}],k=function(a,c){return function(){return a.call(this,c)}}.bind(this),l=0;l<g.length;l++){var h=g[l],m=h.predicate;this["next"+h.name]=k(this.gotoNextX,m);this["last"+h.name]=k(this.gotoLastX,m)}this.previousNode=this.lastNode}
Game.prototype={setCurrentNodeMarkers:function(){var a=this.board;a.removeAllMarkers();a.removeAllLabels();a.removeBranchPointLabels();var c=this.curNode;if(c.status.mark){c.marks.LB&&a.setLabels(c.marks.LB);for(var b="TR CR SQ MA TW TB".split(" "),d=0;d<b.length;d++){var e=b[d];c.marks[e]&&this.setMarkers(c.marks[e],e,!0)}}this.markBranchPoints&&this.markBranchPointsIfAny();this.markCurrentMove&&!this.showMoveNumber?a.markCurrentMove(c.move.point):a.markCurrentMove(null)},setMarkers:function(a,c,
b){var d=this.board;if(b)for(b=0;b<a.length;b++){var e=a[b];e.coorFrom?(e=this.evaluatePointRange(e.coorFrom,e.coorTo),d.setMarkers(e,c)):d.setMarker(e,c)}else d.setMarkers(a,c)},setMarkCurrentMove:function(a){(this.markCurrentMove=a)?this.board.markCurrentMove(this.curNode.move.point):this.board.markCurrentMove(null)},setMarkBranchPoints:function(a){(this.markBranchPoints=a)?this.markBranchPointsIfAny():this.board.removeBranchPointLabels()},markBranchPointsIfAny:function(){var a=this.curNode.branchPoints;
if(a)for(var c=0;c<a.length;c++)if(!(25<c)){var b=a[c],d=String.fromCharCode(65+c);this.board.setLabel(b,d,"branch_point")}},setShowMoveNumber:function(a){"boolean"===typeof a?(this.showMoveNumber=a,0==this.showMoveNumberCount&&(this.showMoveNumberCount=1)):"number"===typeof a?(this.showMoveNumberCount=a,this.showMoveNumber=0<a):"string"===typeof a&&(a=parseInt(a),NaN(a)||(this.showMoveNumberCount=a,this.showMoveNumber=0<a));this.showMoveNumber?this.board.markCurrentMove(null):this.board.markCurrentMove(this.curNode.move.point);
this.resetMoveNumbers()},resetMoveNumbers:function(){this.board.hideMoveNumbers();if(this.showMoveNumber){for(var a=[],c=this.showMoveNumberCount,b=this.curNode.belongingVariation,d=this.curNode,e=this.curNode.position;0<c;c--){var f=d.move.point;if(f){var g=e[f.x][f.y];g&&g.node===d&&(f={x:f.x,y:f.y,color:d.move.color,moveNumber:d.numbers.displayMoveNumber},d===this.curNode&&(f.current=!0),a.push(f))}if(!b.realGame&&(d.status.variationFirstNode||d.belongingVariation!==b))break;d=d.previousNode;if(!d)break}this.board.showMoveNumbers(a)}},
hideMoveNumbers:function(){this.board.hideMoveNumbers()},handleMoveNumbers:function(a){var c=this.board,b=this.curNode;if(b.status.mark)this.hideMoveNumberTemporarily=!0,this.hideMoveNumbers(),this.markCurrentMove&&c.markCurrentMove(b.move.point);else if(this.hideMoveNumberTemporarily)this.hideMoveNumberTemporarily=!1,this.resetMoveNumbers();else{var d=!1;if(0!==this.showMoveNumberCount&&!this.showMoveNumberCount){if(b.label&&a.nextNode==b){var e=b.belongingVariation;if(e.realGame||e==a.belongingVariation)(d=
b.move.point)?(e=b.numbers.displayMoveNumber,d={x:d.x,y:d.y,color:b.move.color,moveNumber:e,current:!0},c.showMoveNumber(d)):c.unmarkCurrentMoveNumber(),d=!0}if(a.previousNode==b&&(e=a.belongingVariation,e.realGame||e==b.belongingVariation)){if(d=b.move.point)e=b.numbers.displayMoveNumber,d={x:d.x,y:d.y,color:b.move.color,moveNumber:e,current:!0},c.showMoveNumber(d);d=!0}}d||this.resetMoveNumbers()}},evaluatePointRange:function(a,c){for(var b=[],d=c.x,e=a.y,f=c.y,g=a.x;g<=d;g++)for(var k=e;k<=f;k++)b.push({x:g,
y:k});return b},diffPosition:function(a,c){for(var b=[],d=[],e=[],f=0;f<this.boardSize;f++){var g=a[f],k=c[f];if(g!==k)for(var l=0;l<this.boardSize;l++){var h=g[l],m=k[l];if(h!==m&&(h||m)){var n=!1,p=!1;m?h?h.color!=m.color&&(p=n=!0):p=!0:n=!0;h={x:f,y:l};n&&b.push(h);p&&("B"==m.color?e.push(h):d.push(h))}}}return{stonesToRemove:b,stonesToAddB:e,stonesToAddW:d}},playNode:function(a){if(!a)return!1;var c=this.board,b=this.curNode,d=this.curNode=a;a=!0;if(d.status.positionBuilt){if(d==b)return!1;if(b.nextNode!=
d||d.status.capture||d.status.setup)b.previousNode!=d||b.status.capture||b.status.setup?(d=this.diffPosition(b.position,d.position),c.removeStones(d.stonesToRemove),c.addStones(d.stonesToAddB,"B"),c.addStones(d.stonesToAddW,"W")):(e=b.move.point)&&c.removeStone(e);else{var e=d.move.point;e&&c.placeStone(e,d.move.color)}}else a=(new PositionBuilder(this,d)).buildPosition();this.setCurrentNodeMarkers();this.handleMoveNumbers(b);return a},gotoNextX:function(a){for(var c=this.curNode;;){if(c.nextNode)c=
c.nextNode;else if(c.variations)c=c.variations[0].nodes[0];else return!1;if(!c)return!1;if(a.call(c,c))return this.playNode(c)}},gotoLastX:function(a){for(var c=this.curNode;;){c=c.previousNode;if(!c)return!1;if(a.call(c,c))return this.playNode(c)}},firstNode:function(){return this.playNode(this.gameModel.nodes[0])},gotoNode:function(a){var c;"string"===typeof a?c=this.nodeMap[a]:"number"===typeof a?c=this.nodesByMoveNumber[a]:a instanceof Node&&(c=a);return c?this.playNode(c):!1},goinBranch:function(a){var c=
this.curNode.variations;if(c){var b;"number"===typeof a?b=c[a]:"string"===typeof a&&1==a.length&&(a=a.charCodeAt(0)-65,b=c[a]);if(b)return this.playNode(b.nodes[0])}return!1},gotoVariationBegin:function(){return this.inRealGame()||this.curNode.status.variationFirstNode?!1:this.gotoLastX(function(a){return a.status.variationFirstNode})},gotoVariationEnd:function(){return this.inRealGame()||this.curNode.status.variationLastNode?!1:this.gotoNextX(function(a){return a.status.variationLastNode})},gotoGameEnd:function(){return this.playNode(this.gameEndingNode)},
gotoNextNMoves:function(a){a=a||10;for(var c=this.curNode;0<a;a--)if(c.nextNode)c=c.nextNode;else if(c.variations)c=c.variations[0].nodes[0];else break;return this.playNode(c)},gotoLastNMoves:function(a){a=a||10;for(var c=this.curNode;0<a;a--)if(c.previousNode)c=c.previousNode;else break;return this.playNode(c)},gotoBaseNode:function(){return this.inRealGame()?!1:this.playNode(this.curNode.belongingVariation.baseNode)},inRealGame:function(){return this.curNode.belongingVariation.realGame}};
function GameModel(){this.realGame=!0;this.nodes=[]}GameModel.prototype={traverseNodes:function(a,c,b){for(var d=this.nodes,e=0;e<d.length;e++){var f=d[e];if(c&&!1===c.call(f,f,b))break;if(f=f.variations)for(var g=0;g<f.length;g++){var k=f[g];if(a&&!1===a.call(k,k,b))return b;k.traverseNodes(a,c,b)}}return b},selectNodes:function(a){return traverseNodes(null,function(c,b){a.call(c,c)&&b.push(c)},[])}};function Variation(a,c){this.baseNode=a;this.parentVariation=c;this.realGame=!1;this.nodes=[]}
Variation.prototype=GameModel.prototype;function Node(a,c){this.previousNode=a;this.belongingVariation=c;this.props={};this.status={}}Node.prototype={};String.prototype.trim||(String.prototype.trim=function(){rtrim=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;return this.replace(rtrim,"")});
...
c&&k!==l&&(m=d(m,(k+2)%4),!1===m))return!1}}var e={},f=this;return d(a)},checkGroupLiberties:function(a,c){var b=[];return!1===this.traverseGroup(a,c,function(a,c){b.push(a);for(var f=0;4>f;f++){var g=c[f];if(null!=g&&null==g.color)return!1}})?{hasLiberty:!0}:{hasLiberty:!1,groupPoints:b}},removeStones:function(a,c){if(c)for(var b=0;b<a.length;b++){var d=a[b];d.coorFrom?(d=this.game.evaluatePointRange(d.coorFrom,d.coorTo),this.removeStones(d,!1)):(this.setPointColor(x,y,null),this.board.removeStone(d))}else this.setPointsStatus(a,
null),this.board.removeStones(a)},addStones:function(a,c,b){if(b)for(b=0;b<a.length;b++){var d=a[b];d.coorFrom?(d=this.game.evaluatePointRange(d.coorFrom,d.coorTo),this.addStones(d,c,!1)):(this.setPointColor(d.x,d.y,c),this.board.placeStone(d,c))}else this.setPointsStatus(a,c),this.board.addStones(a,c)},checkOpponentLiberties:function(a,c){for(var b=[],d=this.getAdjacentPointsStatus(a),e=0;4>e;e++){var f=d[e];f&&f.color==c&&(f=this.checkGroupLiberties(f,f.color),f.hasLiberty||(f=f.groupPoints,this.removeStones(f,
...
e;b=a.move.accumulatedCaptures;b={B:b.B,W:b.W};b[c]+=e.length;a.move.accumulatedCaptures=b}else if(!this.checkGroupLiberties(b,c).hasLiberty)return yogo.logWarn("is self capture? ("+b.x+","+b.y+","+c+")","play move"),this.setPointColor(b.x,b.y,null),this.board.removeStone(b),!1;return!0},buildPosition:function(){var a=!0,c=this.curNode;if(c.status.positionEvaluated)return a;var b=c.previousNode;if(b)b.status.positionBuilt||(new PositionBuilder(this.game,b)).buildPosition(),this.basePosition=b.position,
c.move.accumulatedCaptures=b.move.accumulatedCaptures;else{this.basePosition=[];for(b=0;b<this.boardSize;b++)this.basePosition[b]=[];c.move.accumulatedCaptures={B:0,W:0}}c.status.move&&(a=this.evaluateMove());if(c.status.setup&&(c.setup.AB&&this.addStones(c.setup.AB,"B",!0),c.setup.AW&&this.addStones(c.setup.AW,"W",!0),c.setup.AE))for(var b=function(a){var c=this.getPointColor(a.x,a.y);c&&(d.push({x:a.x,y:a.y,color:c}),this.setPointColor(a.x,a.y,null),this.board.removeStone(a))},d=c.setup.aeRemovedStones=
[],e=c.setup.AE,f=0;f<e.length;f++){var g=e[f];if(g.coorFrom)for(var g=this.game.evaluatePointRange(g.coorFrom,g.coorTo),k=0;k<g.length;k++)b(g[k]);else b(g)}c.position=this.getFinalPosition();c.status.positionBuilt=!0;return a}};
...
a.props.B+"],W["+a.props.W+"]","node");a.status.move&&(a.move.color=a.move.B?"B":"W",a.move.point=a.move.W||a.move.B);delete a.props},{});b.traverseNodes(null,function(a,c){var b=a.previousNode;b?(b=b.numbers,b=a.status.move||a.status.pass?[b.globalMoveNumber+1,b.displayMoveNumber+1,b.variationMoveNumber+1]:[b.globalMoveNumber,b.displayMoveNumber,b.variationMoveNumber]):b=a.status.move||a.status.pass?[1,1,1]:[0,0,0];a.numbers={globalMoveNumber:b[0],displayMoveNumber:b[1],variationMoveNumber:b[2]};
a.move.MN&&(a.numbers.displayMoveNumber=a.move.MN);a.status.variationFirstNode&&(a.numbers.variationMoveNumber=a.status.move||a.status.pass?1:0);if(a.variations){for(var b=a.variations,d=[],l=0;l<b.length;l++){var h=b[l].nodes[0];h.status.move&&d.push(h.move.B||h.move.W)}a.branchPoints=d}},{})}},processGameInfo:function(a){function c(a,b){for(var c=0;c<b.length;c++){var d=b[c],e=d[0];a[d[1]]=a[e];delete a[e]}}var b={};a.gameInfo=b;var d=a.nodes[0].props;d.GM&&"1"!==d.GM&&yogo.logError("unsupported game type: GM\x3d"+
d.GM,"game info");d.SZ||yogo.logError("missing board size(SZ)","game info");for(name in d){var e=this.gameInfoPropNameToGroup[name];if(e){b[e]||(b[e]={});var f=d[name];this.propNameToType[name]&&(f=this.propertyTypeConvert(f,this.propNameToType[name],a.boardSize));b[e][name]=f}else this.nodePropNameToGroup&&this.nodePropNameToGroup[name]||yogo.logWarn("unknown property name: "+name,"game info")}b.blackPlayer&&c(b.blackPlayer,[["PB","name"],["BR","rank"],["BS","species"],["BT","term"]]);b.whitePlayer&&
c(b.whitePlayer,[["PW","name"],["WR","rank"],["WS","species"],["WT","term"]]);b=b.root.SZ;(isNaN(b)||5>b||51<b)&&yogo.logError("wrong board size(SZ)","game info");a.boardSize=b},parseCoordinate:function(a,c){if(!a.match(/^[a-z][a-z]$/i))return yogo.logWarn("wrong coordinate: "+a,"node"),null;var b=a.charCodeAt(0),d=a.charCodeAt(1),b=97>b?26+b-65:b-97,d=97>d?26+d-65:d-97;return b>=c||d>=c?null:{x:b,y:d}},propertyTypeConvert:function(a,c,b){var d=a;if(c)if(0<=["lableList","pointList","stringArray"].indexOf(c)?
a instanceof Array||(a=[a]):a instanceof Array&&(a=a[0]||""),"point"==c)a=""==a?null:this.parseCoordinate(a,b);else if("lableList"==c){c=[];for(b=0;b<a.length;b++){var e=a[b].split(":"),d=e[0];if(e=e[1])d=this.parseCoordinate(d),null!=d&&(d.label=e,c.push(d))}a=0<c.length?c:null}else if("pointList"==c){c=[];for(b=0;b<a.length;b++)d=a[b],0<d.indexOf(":")?(e=d.split(":"),d=this.parseCoordinate(e[0]),e=this.parseCoordinate(e[1]),d&&e&&c.push({coorFrom:d,coorTo:e})):(d=this.parseCoordinate(d),null!=d&&
c.push(d));a=0<c.length?c:null}else"triple"==c?a="2"==a?2:1:"bool"==c?a=!0:"integer"==c?(a=parseInt(a),isNaN(a)&&yogo.logWarn("can't parse to Integer: "+name+","+d,"node")):"float"==c?(a=parseFloat(a),isNaN(a)&&yogo.logWarn("can't parse to Float: "+name+","+d,"node")):yogo.logWarn("to do: "+name,"node");return a}};
yogo={log:function(a,c,b){if(window.console&&((b=window.console[b])||(b=window.console.log),b instanceof Function)){c||(c="yogo");try{b.call(window.console,c+":",a)}catch(d){}}},logInfo:function(a,c){yogo.log(a,c,"info")},logWarn:function(a,c){yogo.log(a,c,"warn")},logError:function(a,c){yogo.log(a,c,"error")}};